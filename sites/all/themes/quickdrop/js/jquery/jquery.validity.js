...
jQuery.validity = {
    ...
    patterns:{
        ...
        date:/^((0?\d)|(1[012]))[\/-]([012]?\d|30|31)[\/-]\d{1,4}jQuery/,
        ...
        usd:/^\jQuery?((\d{1,3}(,\d{3})*)|\d+)(\.(\d{2})?)?jQuery/,
        url:/^(https?|ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\jQuery&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\jQuery&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\jQuery&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\jQuery&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\jQuery&'\(\)\*\+,;=]|:|@)|\/|\?)*)?jQuery/i,
        ...
        number:/^[+-]?(\d+(\.\d*)?|\.\d+)([Ee]-?\d+)?jQuery/,
        
        zip:/^\d{5}(-\d{4})?jQuery/,
        phone:/^[2-9]\d{2}-\d{3}-\d{4}jQuery/,
        guid:/^(\{?([0-9a-fA-F]){8}-(([0-9a-fA-F]){4}-){3}([0-9a-fA-F]){12}\}?)jQuery/,
        time12:/^((0?\d)|(1[012])):[0-5]\d?\s?[aApP]\.?[mM]\.?jQuery/,
        time24:/^(20|21|22|23|[01]\d|\d)(([:][0-5]\d){1,2})jQuery/,
    ...
    out:{
        ...
        raise:function(jQueryobj, msg) {
            this.defer("raise", jQueryobj, msg);
        },
        raiseAggregate:function(jQueryobj, msg) {
            this.defer("raiseAggregate", jQueryobj, msg);
        },
        defer:function(name) {
            var
                v = jQuery.validity,
...
jQuery.fn.extend({
    ...
    require:function(msg) {
        return validate(
            ...
            function(obj) {
                if (jQuery(obj).val()) {
                    return jQuery(obj).val() != null && !!jQuery(obj).val().length;
                }
                return false;
            },
            msg || jQuery.validity.messages.require
        );
    },
    ...
    match:function(rule, msg) {
        ...
        if (!msg) {
            ...
            msg = jQuery.validity.messages.match;

            // If there's a more specific one, use that.
            if (typeof (rule) === "string" && jQuery.validity.messages[rule]) {
                msg = jQuery.validity.messages[rule];
            }
        }

        // If the rule is named, rather than specified:
        if (typeof (rule) == "string") {
            rule = jQuery.validity.patterns[rule];
        }
    ...
    range:function(min, max, msg) {
        return validate(
            ...
            msg || format(
                jQuery.validity.messages.range, {
                    min:jQuery.validity.settings.argToString(min),
                    max:jQuery.validity.settings.argToString(max)
                }
            )
        );
    },
    ...
    greaterThan:function(min, msg) {
        return validate(
            ...
            msg || format(
                jQuery.validity.messages.greaterThan, {
                    min:jQuery.validity.settings.argToString(min)
                }
            )
        );
    ...
    greaterThanOrEqualTo:function(min, msg) {
        return validate(
            ...
            msg || format(
                jQuery.validity.messages.greaterThanOrEqualTo, {
                    min:jQuery.validity.settings.argToString(min)
                }
            )
        );
    ...
    lessThan:function(max, msg) {
        return validate(
            ...
            msg || format(
                jQuery.validity.messages.lessThan, {
                    max:jQuery.validity.settings.argToString(max)
                }
            )
        );
    ...
    lessThanOrEqualTo:function(max, msg) {
        return validate(
            ...
            msg || format(
                jQuery.validity.messages.lessThanOrEqualTo, {
                    max:jQuery.validity.settings.argToString(max)
                }
            )
        );
    ...
    maxLength:function(max, msg) {
        return validate(
            ...
            msg || format(
                jQuery.validity.messages.tooLong, {
                    max:max
                }
            )
        );
    ...
    minLength:function(min, msg) {
        return validate(
            ...
            msg || format(
                jQuery.validity.messages.tooShort, {
                    min:min
                }
            )
        );
    ...
    alphabet:function(alpha, msg) {
        ...
        return validate(
            ...
            msg || format(
                jQuery.validity.messages.alphabet, {
                    chars:chars.join(", ")
                }
            )
        );
    ...
    minCharClass:function(charClass, min, msg) {
        if (typeof(charClass) == "string") {
            ...
            if (jQuery.validity.charClasses[charClass]) {
                charClass = jQuery.validity.charClasses[charClass];
            }
        }
        ...
        return validate(
            ...
            msg || format(
                jQuery.validity.messages.minCharClass, {
                    min:min,
                    charClass:charClass
                }
            )
    ...
    maxCharClass:function(charClass, max, msg) {
        ...
        return validate(
            ...
            msg || format(
                jQuery.validity.messages.maxCharClass, {
                    max:max,
                    charClass:charClass
                }
            )
    ...
    nonHtml:function(msg) {
        return validate(
            ...
            function(obj) {
                return jQuery.validity.patterns.nonHtml.test(obj.value);
            },

            msg || jQuery.validity.messages.nonHtml
        );
    },
    ...
    equal:function(arg0, arg1) {
        var
            ...
            // elements.
            jQueryreduction = (this.reduction || this)
                .filter(jQuery.validity.settings.elementSupport),

            transform = function(val) {
                return val;
            },

            msg = jQuery.validity.messages.equal;

        if (jQueryreduction.length) {

            // Figure out what arguments were specified.
            if (jQuery.isFunction(arg0)) {
                transform = arg0;
            ...
            if (!valid) {
                raiseAggregateError(jQueryreduction, msg);

                // The set reduces to zero valid elements.
                this.reduction = jQuery([]);
            }
        }
    ...
    distinct:function(arg0, arg1) {
        var
            ...
            jQueryreduction = (this.reduction || this).filter(jQuery.validity.settings.elementSupport),

            transform = function(val) {
                return val;
            },

            msg = jQuery.validity.messages.distinct,
        ...
        if (jQueryreduction.length) {
            ...
            if (!valid) {
                ...
                repeatedVal = jQuery.unique(repeatedVal);
    ...
    sum:function(sum, msg) {
        // If a reduced set is attached, use it. Also, remove unsupported
        // elements.
        var jQueryreduction = (this.reduction || this).filter(jQuery.validity.settings.elementSupport);

        if (jQueryreduction.length && sum != numericSum(jQueryreduction)) {
            raiseAggregateError(
                jQueryreduction,
                msg || format(
                    jQuery.validity.messages.sum,
                    { sum:sum }
                )
            );
    ...
    sumMax:function(max, msg) {
        ...
        if (jQueryreduction.length && max < numericSum(jQueryreduction)) {
            raiseAggregateError(
                jQueryreduction,
                msg || format(
                    jQuery.validity.messages.sumMax,
                    { max:max }
                )
            );
    ...
    sumMin:function(min, msg) {
        ...
        if (jQueryreduction.length && min > numericSum(jQueryreduction)) {
            raiseAggregateError(
                jQueryreduction,
                msg || format(
                    jQuery.validity.messages.sumMin,
                    { min:min }
                )
            );
    ...
    radioChecked:function(val, msg) {
        ...
        if (jQueryreduction.is(":radio") && jQueryreduction.find(":checked").val() != val) {
            raiseAggregateError(
                jQueryreduction,
                msg || jQuery.validity.messages.radioChecked
            );
        }
    },
    ...
    radioNotChecked:function(val, msg) {
        ...
        if (jQueryreduction.is(":radio") && jQueryreduction.filter(":checked").val() == val) {
            raiseAggregateError(
                jQueryreduction,
                msg || jQuery.validity.messages.radioChecked
            );
    ...
    checkboxChecked:function(msg) {
        return validate(
            ...
            function(obj) {
                return !jQuery(obj).is(":checkbox") || jQuery(obj).is(":checked")
            },
    ...
    assert:function(expression, msg) {
        ...
        // elements.
        var jQueryreduction = this.reduction || this;
        ...
        if (jQueryreduction.length) {
            ...
            if (jQuery.isFunction(expression)) {
                return validate(
                    this,
                    expression,
                    msg || jQuery.validity.messages.generic
                );
            }
...
// Do non-aggregate validation. Subject each element in jQueryobj to the regimen.
// Raise the specified error on failures. This function is the heart of
// validity:
function validate(jQueryobj, regimen, message) {

    var
        // If a reduced set is attached, use it Also, remove any unsupported
        // elements.
        jQueryreduction = (jQueryobj.reduction || jQueryobj).filter(jQuery.validity.settings.elementSupport),

        // Array to store only elements that pass the regimen.
        elements = [];

    // For each in the reduction.
    jQueryreduction.each(
        function() {
    ...
    jQueryobj.reduction = jQuery(elements);
...
function addToReport() {
    if (jQuery.validity.isValidating()) {
...
function raiseError(obj, msg) {
    ...
    jQuery.validity.out.raise(jQuery(obj), msg);
}

// Inform the report of a failure and display an aggregate error according to
// the idiom of the current output mode.
function raiseAggregateError(jQueryobj, msg) {
    addToReport();

    jQuery.validity.out.raiseAggregate(jQueryobj, msg);
}
...
function infer(field) {
    var
        jQueryf = jQuery(field),
        id = jQueryf.prop("id"),
        ret = jQuery.validity.settings.defaultFieldName;

    // Check for title.
    if (jQueryf.prop("title").length) {
        ret = jQueryf.prop("title");
    }

    // Check for UpperCamelCase.
    else if (/^([A-Z0-9][a-z]*)+jQuery/.test(id)) {
        ret = id.replace(/([A-Z0-9])[a-z]*/g, " jQuery&");
    }

    // Check for lowercase_separated_by_underscores
    else if (/^[a-z0-9]+(_[a-z0-9]+)*jQuery/.test(id)) {
        var arr = id.split("_");
...
(function(jQuery) {
    jQuery.validity.outputs.tooltip = {
        tooltipClass:"validity-tooltip",
    
        start:function() {
            jQuery("." + jQuery.validity.outputs.tooltip.tooltipClass)
                .remove();
        },
        ...
        raise:function(jQueryobj, msg) {
            ...
            if (jQuery.validity.settings.fadeOutTooltipsOnFocus) {
                jQueryobj.on("focus", function() {
                    tooltip.fadeOut();
                });
            }
        },
        ...
        raiseAggregate:function(jQueryobj, msg) {
            ...
            if (jQueryobj.length) {
                this.raise(jQueryobj.filter(":last"), msg);
            }
        }
    };
})(jQuery);
...
(function(jQuery) {
    function getIdentifier(jQueryobj) {
        return jQueryobj.attr('id').length ?
            jQueryobj.attr('id') :
            jQueryobj.attr('name');
    }

    jQuery.validity.outputs.label = {
        cssClass:"error",
    
        start:function() {
            // Remove all the existing error labels.
            jQuery("." + jQuery.validity.outputs.label.cssClass)
                .remove();
        },
            ...
            // If not valid and scrollTo is enabled, scroll the page to the first error.
            if (!results.valid && jQuery.validity.settings.scrollTo) {
                location.hash = jQuery("." + jQuery.validity.outputs.label.cssClass + ":eq(0)").attr('for');
            }
        },

        raise:function(jQueryobj, msg) {
            var
                labelSelector = "." + jQuery.validity.outputs.label.cssClass + "[for='" + getIdentifier(jQueryobj) + "']";

            // If an error label already exists for the bad input just update its text:
            if (jQuery(labelSelector).length) {
                jQuery(labelSelector).text(msg);
            }

            // Otherwize create a new one and stick it after the input:
            else {
                jQuery("<label/>")
                    .attr("for", getIdentifier(jQueryobj))
                    .addClass(jQuery.validity.outputs.label.cssClass)
                    .text(msg)
        ...
        raiseAggregate:function(jQueryobj, msg) {
            // Just raise the error on the last input.
            if (jQueryobj.length) {
                this.raise(jQuery(jQueryobj.get(jQueryobj.length - 1)), msg);
            }
        }
    };
})(jQuery);
...
(function(jQuery) {
    ...
    jQuery.validity.outputs.modal = {
        start:function() {
            ...
            // If not valid and scrollTo is enabled, scroll the page to the first error.
            if (!results.valid && jQuery.validity.settings.scrollTo) {
                location.hash = jQuery("." + errorClass + ":eq(0)").attr('id');
            }
        },
        ...
        raise:function(jQueryobj, msg) {
            if (jQueryobj.length) {
                var
                    off = jQueryobj.offset(),
                    obj = jQueryobj.get(0),

                    // Design a style object based off of the input's location.
                    errorStyle = {
                        left:parseInt(off.left + jQueryobj.width() + 4, 10) + "px",
...
(function(jQuery) {
    ...
    jQuery.validity.outputs.summary = {
        start:function() {
            jQuery(errors).removeClass(erroneous);
            buffer = [];
        },
            ...
            if (buffer.length) {
                ...
                if (jQuery.validity.settings.scrollTo) {
                    location.hash = jQuery(errors + ":eq(0)").attr("id");
                }
            }
        },
        ...
        raise:function(jQueryobj, msg) {
            buffer.push(msg);
            jQueryobj.addClass(erroneous);
        },

        raiseAggregate:function(jQueryobj, msg) {
            this.raise(jQueryobj, msg);
        },
